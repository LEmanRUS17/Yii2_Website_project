...
$(window).on('load', function() { // проверяет, загружен ли весь сайт 
		$('#status').fadeOut(); // сначала исчезнет анимация загрузки 
		$('#preloader').delay(350).fadeOut('slow'); // исчезнет белый DIV, закрывающий веб-сайт. 
