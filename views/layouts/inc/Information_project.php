<section id="about">
    <div class="box">
        <h2 class="section-title">Кто за всем этим стоит</h2>
        <div class="row">
            <div class="col-md-5 col-md-push-7 col-sm-12">
                <figure class="frame"><img src="web/images/art/about.jpg" alt="" /></figure>
            </div>
            <!-- /column -->
        ...
        <div class="services-1">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <!-- /.icon -->
                    <div class="text">
                        <h5>Фотография Ювелирных Изделий</h5>
